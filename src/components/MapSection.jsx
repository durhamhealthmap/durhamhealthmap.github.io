...
const EMBED_CONFIGS = {
  ...
  'urgent-care': {
    id: 'viz1753074440006',
    html: `<div class='tableauPlaceholder' id='viz1753074440006' style='position: relative'><noscript><a href='#'><img alt='Urgent Care/After Hours ' src='https://public.tableau.com/static/images/DH/DHM_UCAH/UrgentCareAfterHours/1_rss.png' style='border: none' /></a></noscript><object class='tableauViz'  style='display:none;'><param name='host_url' value='https%3A%2F%2Fpublic.tableau.com%2F' /> <param name='embed_code_version' value='3' /> <param name='site_root' value='' /><param name='name' value='DHM_UCAH/UrgentCareAfterHours' /><param name='tabs' value='no' /><param name='toolbar' value='yes' /><param name='static_image' value='https://public.tableau.com/static/images/DH/DHM_UCAH/UrgentCareAfterHours/1.png' /> <param name='animate_transition' value='yes' /><param name='display_static_image' value='yes' /><param name='display_spinner' value='yes' /><param name='display_overlay' value='yes' /><param name='display_count' value='yes' /><param name='language' value='en-US' /><param name='filter' value='publish=yes' /></object></div>`
  },
  'uninsured': {
    id: 'viz1753070460439',
